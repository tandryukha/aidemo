...
July 18, 2026 · Video Marketing for Software · 7 min read · https://aidemo.top/blog/product-hunt-launch-video/
...
- Product Hunt's feed shows a 240x240 square thumbnail, not your video; the video lives in the gallery as a YouTube link, so the thumbnail carries the muted first impression.
- Gallery images are 1270x760 (1.67:1) and at least 2 are required; the thumbnail must be under 3MB, and its GIF animates only on hover, so the first frame has to stand alone.
- About 53% of Product-of-the-Day products since 2021 included a video, but Product Hunt itself calls video 'not always necessary' -- it is a correlation, not a proven lift.
- The video is a YouTube link, so it inherits YouTube's spec: MP4/H.264, 16:9, 1080p at ~8 Mbps, AAC audio -- the same 16:9 master every other channel uses.
- Pick one job for the video, a demo walkthrough or a maker story, and record it the night before from a five-shot list rather than a two-week production.
...
So a Product Hunt launch is two assets doing two jobs. The thumbnail is a muted, motionless first impression that has to read at the size of a large app icon. The gallery video is the second sell, watched only by people who already clicked, which means it can assume interest but not patience. Get the spec for both right and you have removed the mechanical reasons a launch stalls; what is left to win on is the product. Product Hunt is one row in [the wider channel matrix](/blog/video-marketing-for-software), but it is the row with the most specific and least-documented rules.
...
Two of those cells trip people. First, the thumbnail GIF does not autoplay in the feed; it animates only when a viewer hovers, so a motion thumbnail that depends on its animation to make sense shows a random frame to everyone who does not hover, which on mobile is nearly everyone ([Product Hunt help center, accessed July 2026](https://help.producthunt.com/en/articles/479557-how-to-post-a-product)). Design the first frame to stand alone. Second, the video is a YouTube link, not an upload ([Product Hunt help center, accessed July 2026](https://help.producthunt.com/en/articles/479557-how-to-post-a-product)), so its spec is YouTube's spec: an MP4 in H.264 at 16:9, 1080p around 8 Mbps for standard frame rates, with AAC audio ([YouTube, accessed July 2026](https://support.google.com/youtube/answer/1722171)). That is the same 16:9 master you keep for a landing hero and a YouTube upload, which is the whole reason to treat the recording as one master with per-channel cuts rather than a fresh shoot per surface.

## The 53% number, traced to where it comes from

Every launch guide repeats that products with a video win more. Follow the claim to its origin and it is a single first-party line: Product Hunt's own launch guide states that "about 53% of products that reached Product of the Day since 2021 include a video" ([Product Hunt, accessed July 2026](https://www.producthunt.com/launch/preparing-for-launch)). That is the source. The larger multiples that circulate on marketing blogs do not trace to a published method, and Product Hunt itself declines the causal version: the same page calls video "not always necessary," says it "can help depending on what your product is," and notes that a quick Loom demo is a fine stand-in for a produced piece.

Read honestly, 53% is a correlation, not a lift. Products that reach Product of the Day are made by teams that invested in the launch, and a video is one visible signal of that investment, sitting alongside a crafted thumbnail, a maker's first comment, and a rallied audience. The video may help the ranking; it is not a coin you insert to buy one. What the number does justify is a floor: video is table stakes often enough that skipping it is a decision to defend, not a default. If the flow is already recorded for [your broader launch-day kit](/blog/product-launch-video), the Product Hunt cut is nearly free, and nearly free is the right budget for an asset with a correlational rather than causal payoff.
...
The maker story is where a [webcam overlay earns its place](/blog/screen-recording-with-webcam): a founder's face on launch day builds the trust a bare screen recording cannot, and Product Hunt's audience expects a human in the comments anyway. The demo walkthrough is the safer default for a product whose value is legible on screen. Whichever you pick, length is a retention decision rather than a house style, [tuned to where the clip plays](/blog/how-long-should-a-demo-video-be), and the gallery rewards the shorter end because the viewer is one click from leaving.
...
Captions still matter, because 69% of consumers watch video with the sound off in public places, and captions make 80% of them likelier to watch a clip through to the end ([Verizon Media via Forbes, 2019](https://www.forbes.com/sites/tjmccue/2019/07/31/verizon-media-says-69-percent-of-consumers-watching-video-with-sound-off/)). Someone browsing Product Hunt at a desk with a muted tab is squarely in that 69%. So burn captions into the file instead of leaning on YouTube's auto-captions, which land late and mangle product names; the [captions-as-pixels case](/blog/demo-video-captions) carries over unchanged. The composite rule for this surface: the thumbnail carries the silent hook, the first five seconds of the video show the product doing the thing, and captions keep both watchable with the sound off.
...
- [Product Hunt - Preparing for your launch (video and asset guidance, the 53% figure)](https://www.producthunt.com/launch/preparing-for-launch)
- [Product Hunt Help Center - How to post a product (thumbnail, gallery, and video specs)](https://help.producthunt.com/en/articles/479557-how-to-post-a-product)
