...
July 18, 2026 · Video Marketing for Software · 8 min read · https://aidemo.top/blog/linkedin-video-for-b2b-software/
...
- LinkedIn is B2B's top video channel (81% of teams post there, Wistia 2026), but a pasted YouTube link is a reach tax because the feed ranks on dwell time.
- LinkedIn's feed has ranked on dwell time since 2020; a native upload autoplays and banks dwell, while a link's best case is a click that sends the viewer off-platform.
- Size the in-feed cut square (1:1 or 4:5), not 16:9: at the feed's fixed width a square clip is taller, filling more phone screen and holding the scroll longer.
- Autoplay is muted, so the first two lines of post copy and a captioned first frame are the pitch; keep the clip 15-30s, MP4/H.264, under 500 MB.
- For weeks with no new film, a multi-page document post (PDF) banks the same dwell and is built from the demo's own still frames.

## A pasted YouTube link is a tax on your own reach

For B2B software, LinkedIn is not one channel among several; it is the channel. Wistia's 2026 State of Video, built from the videos it hosts, puts 81% of teams posting video to LinkedIn, ahead of YouTube at 76%, and names LinkedIn B2B's top video-sharing channel ([Wistia, 2026](https://wistia.com/learn/marketing/video-marketing-statistics)). That is where your buyers already scroll. The mistake is in how most teams put a video in front of them: they paste a YouTube link into the post and call it done.

That link is a reach tax, and the reason is in LinkedIn's own feed mechanics. Since 2020 the feed has ranked updates partly on dwell time, the seconds a member spends on an update, through a model that predicts the probability of a skip ([LinkedIn Engineering, 2020](https://www.linkedin.com/blog/engineering/feed/understanding-feed-dwell-time)). LinkedIn's engineers spelled out why they trust dwell over likes and clicks: most members view an update without ever clicking, liking, or commenting, so those actions are missing for the silent majority; they are binary rather than graduated; and a click can be a "click bounce" that means the opposite of interest. Dwell time, by contrast, is "always measurable" and a "real-valued measure of engagement."

Read that back with a YouTube link in hand. The best case for a pasted link is a click, and a click sends the viewer off LinkedIn to youtube.com, ending the dwell the post is ranked on. A native upload does the opposite: it autoplays in place, and every second watched is dwell the feed counts in your favor. The pillar's [channel matrix](/blog/video-marketing-for-software) already flags that a native upload out-reaches a pasted link; the dwell model is why. Upload the file. If you need the YouTube version discoverable, drop that link in the first comment, where it will not compete with the clip for reach.
...
Those numbers are LinkedIn's ([LinkedIn, accessed July 2026](https://www.linkedin.com/help/lms/answer/a424737)); the right-hand column is the opinion. Two cells decide the reach. Length first: LinkedIn recommends 15 to 30 seconds so a clip qualifies for every placement, and the retention data agrees that a short clip is watched while a long one is merely sampled. Vidyard's 2024 benchmark of 943,305 videos found 65% of viewers stay to the end of a sub-minute clip against 20% past twenty minutes ([Vidyard, 2025](https://www.vidyard.com/business-video-benchmarks/)).

Aspect is the cell teams get wrong. A 16:9 clip is the shape of a YouTube master, not a feed clip. At the fixed width of the feed column, a 1:1 or 4:5 video is simply taller than a 16:9 one, so it occupies more of a vertical phone screen and holds the scroll a beat longer, which the dwell model rewards directly. The square cut is not a matter of taste; it is more pixels of screen time per scroll. [The launch-clips piece](/blog/social-cuts-for-product-launch) carries the full cross-platform cut table; this is its LinkedIn column, with the reasoning laid under it.

## Muted autoplay makes your first two lines the pitch

A LinkedIn video autoplays in the feed with the sound off. LinkedIn says so plainly and, for that reason, calls captions strongly recommended because "videos autoplay without sound" ([LinkedIn, accessed July 2026](https://business.linkedin.com/marketing-solutions/native-advertising/video-ads)). So the first view of your demo is silent, and two things carry it.
